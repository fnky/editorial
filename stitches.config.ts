import { TConfig, TCssProperties, TRecursiveUtils } from "@stitches/core";
...
type CSSProperty = keyof TCssProperties<Config>;
...
>(
  ...
  const props: MapVariantToCSSProp<Token, CSSProp> = Object.fromEntries(
    entries
  );
  return props;
}
